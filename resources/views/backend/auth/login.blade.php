        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('login.store')}}" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="mail_address" class="form-control" placeholder="Mail_address" value="{{ old('mail_address') }}" required autocomplete="mail_address" autofocus>
                    @error('mail_address')
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password" class="form-control" placeholder="Password" required autocomplete="current-password" value="{{ old('password') }}">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
